...
const GaiaDividend_1 = __importDefault(require("./view/app/GaiaDividend"));
const Genesis_1 = __importDefault(require("./view/app/Genesis"));
const Governance_1 = __importDefault(require("./view/app/Governance"));
const GovernanceDetail_1 = __importDefault(require("./view/app/GovernanceDetail"));
...
(async () => {
    ...
    skydapp_common_1.SkyRouter.route("genesis/app", Genesis_1.default);
    skydapp_common_1.SkyRouter.route("genesis", GenesisLanding_1.default);
    skydapp_common_1.SkyRouter.route("supernova/app", Supernova_1.default);
    skydapp_common_1.SkyRouter.route("supernova/event", SupernovaEvent_1.default);
    skydapp_common_1.SkyRouter.route("supernova", SupernovaLanding_1.default);
    skydapp_common_1.SkyRouter.route("stabledao/app", StableDAO_1.default);
    skydapp_common_1.SkyRouter.route("stabledao", StableLanding_1.default);
    skydapp_common_1.SkyRouter.route("stabledao/buy", BuyStableDAO_1.default);
    skydapp_common_1.SkyRouter.route("dividend", DividendLanding_1.default);
    skydapp_common_1.SkyRouter.route("dividend/distributor", GaiaDividend_1.default);
    skydapp_common_1.SkyRouter.route("governances", Governance_1.default);
    skydapp_common_1.SkyRouter.route("governance/{id}", GovernanceDetail_1.default);
    if (sessionStorage.__spa_path) {
        skydapp_common_1.SkyRouter.go(sessionStorage.__spa_path);
        sessionStorage.removeItem("__spa_path");
    }
    if (await KlaytnWallet_1.default.connected() !== true &&
        await EthereumWallet_1.default.connected() !== true) {
        new ConnectWalletPopup_1.default(() => { });
    }
})();
