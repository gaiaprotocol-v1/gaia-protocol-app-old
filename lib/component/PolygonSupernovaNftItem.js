...
const PolySupernova_1 = __importDefault(require("../contracts/pfp/PolySupernova"));
...
class PolygonSupernovaNftItem extends skydapp_browser_1.DomNode {
    constructor() {
        ...
        this.append(this.imageDisplay = (0, skydapp_browser_1.el)("img"), this.nameDisplay = (0, skydapp_browser_1.el)("h3"), (0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)("img.send", { src: "/images/icn/send.svg", alt: "send icon" }), {
            click: () => new TransferPopup_1.default(async (to) => {
                ...
                if (from !== undefined) {
                    await PolySupernova_1.default.transferFrom(from, to, this.id);
...
exports.default = PolygonSupernovaNftItem;
//# sourceMappingURL=PolygonSupernovaNftItem.js.map