...
class GenesisNftItem extends skydapp_browser_1.DomNode {
    constructor() {
        ...
        }), (0, skydapp_browser_1.el)(".content-wrap", (0, skydapp_browser_1.el)("section", (0, skydapp_browser_1.el)("header", (0, skydapp_browser_1.msg)("UNCOLLECTED_INTEREST_DESC")), (0, skydapp_browser_1.el)(".amount-wrap", this.klayDisplay = (0, skydapp_browser_1.el)(".klay", "... KLAY")))), (0, skydapp_browser_1.el)(".content-wrap", (0, skydapp_browser_1.el)("section", (0, skydapp_browser_1.el)("header", (0, skydapp_browser_1.msg)("EMERGENCY_DESC")), (0, skydapp_browser_1.el)(".amount-wrap", this.emergencyDisplay = (0, skydapp_browser_1.el)(".klay", "... KLAY"))), (0, skydapp_browser_1.el)(".button-wrap", this.claimButton = (0, skydapp_browser_1.el)("button.klay-button", "미수령 이자 받기", {
            click: async () => {
                await GaiaGenesisUSDCDistributorContract_1.default.claim([this.id]);
                ViewUtil_1.default.waitTransactionAndRefresh();
            }
        }), (0, skydapp_browser_1.el)("button.klay-button", (0, skydapp_browser_1.msg)("CLAIM_REWARDS_BUTTON"), {
            click: async () => {
