...
class StableDAO {
    ...
    async loadInterest() {
        ...
        const mesh = ethers_1.utils.parseEther("0").add(balance.mul(miningIndex.sub(userLastIndex)).div(ethers_1.utils.parseEther("1")));
        ...
        this.interestMeshDisplay.empty().appendText(`${(0, skydapp_browser_1.msg)("STABLEDAO_INTEREST_ACCRUED_DESC")} ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(mesh))} MESH`);
