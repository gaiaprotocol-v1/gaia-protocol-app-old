...
const PolygonSupernovaNftItem_1 = __importDefault(require("../../component/PolygonSupernovaNftItem"));
    ...
    async loadPolygonNFTs() {
        ...
        if (address !== undefined) {
            ...
            for (const nft of data.nfts) {
                const item = new PolygonSupernovaNftItem_1.default().appendTo(this.nftList);
