...
class BuyStableDAO {
    ...
    async loadTab(type) {
        ...
        if (type === "kronos") {
            ...
            const address = await Wallet_1.default.loadAddress();
            if (address !== undefined) {
                const balance = (await GaiaGenesisContract_1.default.balanceOf(address)).toNumber();
