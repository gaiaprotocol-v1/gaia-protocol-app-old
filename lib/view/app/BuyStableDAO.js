...
const GaiaStableDAOOperatorV3Contract_1 = __importDefault(require("../../contracts/GaiaStableDAOOperatorV3Contract"));
...
class BuyStableDAO {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skydapp_browser_1.el)(".buy-stable-dao-view", (0, skydapp_browser_1.el)("h1", "BUY"), (0, skydapp_browser_1.el)("img", { src: "/images/logo/gaia-stable-dao.png", alt: "logo" }), (0, skydapp_browser_1.el)(".selector-container", this.salesDisplay = (0, skydapp_browser_1.el)("p", "SALES: ... EA"), this.priceDisplay = (0, skydapp_browser_1.el)("p", "PRICE: ... oUSDC"), this.totalDisplay = (0, skydapp_browser_1.el)("p", "TOTAL: ... oUSDC"), (0, skydapp_browser_1.el)(".select", this.genesisTab = (0, skydapp_browser_1.el)("a.disable", "Genesis", { click: () => this.loadTab("genesis") }), (0, skydapp_browser_1.el)("hr"), this.supernovaTab = (0, skydapp_browser_1.el)("a.disable", "Supernova", { click: () => this.loadTab("supernova") }), (0, skydapp_browser_1.el)("hr"), this.publicTab = (0, skydapp_browser_1.el)("a.disabled", "Public", { click: () => this.loadTab("public") }))), (0, skydapp_browser_1.el)(".input-container", this.notice = (0, skydapp_browser_1.el)("p"), (0, skydapp_browser_1.el)("input", {
            ...
            click: async () => {
                ...
                if (address !== undefined) {
                    if ((await oUSDCContract_1.default.allowance(address, GaiaStableDAOOperatorV3Contract_1.default.address)).eq(0)) {
                        await oUSDCContract_1.default.approve(GaiaStableDAOOperatorV3Contract_1.default.address, ethers_1.constants.MaxUint256);
                    }
                    else {
            ...
            click: async () => {
                ...
                if (address !== undefined) {
                    if ((await oUSDCContract_1.default.allowance(address, GaiaStableDAOOperatorV3Contract_1.default.address)).eq(0)) {
                    ...
                    else if (await GaiaStableDAOContract_1.default.isMinter(GaiaStableDAOOperatorV3Contract_1.default.address) !== true) {
                        ...
                        if (this.count.toNumber() > 10) {
                            ...
                            await GaiaStableDAOOperatorV3Contract_1.default.mintStableDAO(this.count, nft);
        ...
        })), (0, skydapp_browser_1.el)("a.usdc", (0, skydapp_browser_1.msg)("BUY_USDC_BUTTON"), { href: "https://swapscanner.io/ko/swap?from=0x0000000000000000000000000000000000000000&to=0x754288077d0ff82af7a5317c7cb8c444d421d103", target: "_blank" })), (0, skydapp_browser_1.el)(".nft-container", (0, skydapp_browser_1.el)("h2", (0, skydapp_browser_1.msg)("MY_NFT_TITLE")), this.nftList = (0, skydapp_browser_1.el)("section"))));
        ...
        KlaytnWallet_1.default.on("connect", () => this.loadNFTsDebouncer.run());
    }
    async loadSales() {
        if (await GaiaStableDAOContract_1.default.isMinter(GaiaStableDAOOperatorV3Contract_1.default.address) !== true) {
