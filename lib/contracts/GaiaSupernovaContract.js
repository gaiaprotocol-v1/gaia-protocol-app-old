...
const GaiaSupernova_json_1 = __importDefault(require("./abi/gaia-supernova/artifacts/contracts/GaiaSupernova.sol/GaiaSupernova.json"));
...
class GaiaSupernovaContract extends KIP17Contract_1.default {
    constructor() {
        super(Config_1.default.contracts.GaiaSupernova, GaiaSupernova_json_1.default.abi);
    }
    async totalSupply() {
