...
const GaiaBuyBackFund_json_1 = __importDefault(require("./abi/gaia-genesis/artifacts/contracts/GaiaBuyBackFund.sol/GaiaBuyBackFund.json"));
...
class GaiaBuyBackFundContract extends KlaytnContract_1.default {
    constructor() {
