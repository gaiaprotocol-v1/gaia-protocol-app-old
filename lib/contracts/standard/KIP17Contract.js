...
const KIP17Full_json_1 = __importDefault(require("../abi/gaia-genesis/artifacts/contracts/klaytn-contracts/token/KIP17/KIP17Full.sol/KIP17Full.json"));
const KlaytnContract_1 = __importDefault(require("../KlaytnContract"));
class KIP17Contract extends KlaytnContract_1.default {
    ...
    async transfer(to, id) {
        await this.runWalletMethod("transferFrom", await KlaytnWallet_1.default.loadAddress(), to, id);
    }
    async transferLegacy(to, id) {
        await this.runMethodNew("transferFrom", await KlaytnWallet_1.default.loadAddress(), to, id);
    }
