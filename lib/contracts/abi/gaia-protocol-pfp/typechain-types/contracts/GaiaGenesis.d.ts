...
export interface GaiaGenesisInterface extends utils.Interface {
    functions: {
...
export interface GaiaGenesis extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: GaiaGenesisInterface;
...
//# sourceMappingURL=GaiaGenesis.d.ts.map