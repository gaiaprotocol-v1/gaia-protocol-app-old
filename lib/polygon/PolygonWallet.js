...
class PolygonWallet extends skydapp_common_1.EventContainer {
    constructor() {
        super();
        ...
        if (this.existsInjectedProvider === true) {
            ...
            this.walletConnectProvider = new web3_provider_1.default({ rpc: "wss://rpc-mainnet.matic.quiknode.pro" });
...
exports.default = new PolygonWallet();
//# sourceMappingURL=PolygonWallet.js.map