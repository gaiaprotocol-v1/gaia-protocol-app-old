...
export declare namespace IGaiaDividendDistributor {
  ...
  export type RewardStructOutput = [string, BigNumber, string] & {
    token: string;
    amount: BigNumber;
    merkleRoot: string;
  };
...
export type UpdateDepositorEvent = TypedEvent<
  [string, boolean],
  UpdateDepositorEventObject
>;

export type UpdateDepositorEventFilter = TypedEventFilter<UpdateDepositorEvent>;
...
export interface IGaiaDividendDistributor extends BaseContract {
  ...
  functions: {
    ...
    claimRewards(
      rewardIds: PromiseOrValue<BigNumberish>[],
    ...
    rewards(
      ...
      overrides?: CallOverrides
    ): Promise<[IGaiaDividendDistributor.RewardStructOutput]>;
  ...
  filters: {
    ...
    "Distribute(address,uint256,bytes32,uint256)"(
      token?: null,
      amount?: null,
      merkleRoot?: null,
      rewardId?: null
    ...
    "UpdateDepositor(address,bool)"(
      depositor?: null,
      status?: null
    ): UpdateDepositorEventFilter;
    UpdateDepositor(
      depositor?: null,
      status?: null
    ): UpdateDepositorEventFilter;
