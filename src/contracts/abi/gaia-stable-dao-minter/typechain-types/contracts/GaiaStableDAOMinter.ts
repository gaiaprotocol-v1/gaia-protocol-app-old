...
export interface GaiaStableDAOMinterInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "clearBurnedIds",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "updateIsBuyBackAlive",
...
export interface GaiaStableDAOMinter extends BaseContract {
  ...
  functions: {
    ...
    emergencyWithdraw(
      iUSDCAmount: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    updateDevFund(
      newDevFund: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
