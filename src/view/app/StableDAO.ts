        ...
        Layout.current.content.append(this.container = el(".stable-dao-view",
            el("section",
                ...
                el(".portfolio-container",
                    new PortfolioItem(1, "stepn", "gmt", 3403, 2.67, 1938.279905549, "₩6,593,031.06 (1938.279905549 GMT)", "2022.05.08 ~ 2022.08.08", "1897.62 USDC (1,997.63405178 GMT)", "-73.57% (₩ -4,852,367.45 / $ -3,914.19)"),
                    new PortfolioItem(2, "bitcoin", "btc", 38277205, 2.67, 0.104883, "₩4,044,116.736 (0.104883 BTC)", "2022.06.08 ~ 2022.09.08", "19,314.11 USDC (0.104883 BTC)", "-30.31% (₩ -1,216,970.45 / $ 2,023.74)"),
