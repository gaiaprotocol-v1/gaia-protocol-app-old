        ...
        Layout.current.content.append(this.container = el(".stable-dao-view",
            el("section",
                ...
                el(".portfolio-container",
                    ...
                    new PortfolioItem(3, "ethereum", "eth", 1963000, 2.67, 1.558394, "₩3,058,943 (1.558394 ETH)", "2022.07.21 ~ 2022.10.21", "2,100.71511 USDC (1.558394 BTC)", "-1.32% (₩ -40,434.09 / $ 2,094.65)"),
                ),
            ),
