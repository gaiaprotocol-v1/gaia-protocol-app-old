    ...
    constructor() {
        ...
        Layout.current.content.append(this.container = el(".home-view",
            ...
            el("section",
                ...
                el("a.card", { href: "https://gaiabridge.com/", target: "_blank" },
                ...
                el("a.card", { click: () => { ViewUtil.go("dividend/distributor") } },
                    el(".dividend-img-container",
                        el("img", { src: "/images/logo/gaia-dividend.png", alt: "gaia dividend dao" }),
                    ),
                    el(".content",
                        el("h2", msg("GAIA_DIVIDEND_TITLE")),
                        el("p", msg("GAIA_DIVIDEND_DESC")),
                    ),
                ),
            ),
        ));
